package net.hsmy.base.aspect;

import net.hsmy.base.anotation.SysLogger;
import net.hsmy.base.dao.SysLog;
import net.hsmy.base.service.SysLogService;
import net.hsmy.base.utils.ShiroUtils;
import net.hsmy.base.utils.JsonUtils;
import net.hsmy.base.utils.WebUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("execution(public * net.hsmy.base.controller.admin.*Controller.*(..))")
    //@Pointcut("@annotation(net.hsmy.base.annotation.SysLogger)")
    ...
    public void saveSysLog(JoinPoint joinPoint) {
       ...
       /*
        ...
        logger.info("aspect syslog logcontroller  !"  + sysLog.getUserName());
